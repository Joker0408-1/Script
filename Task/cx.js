...
function Survey() {
    ...
    "Accept": "text/plain, */*; q=0.01"
         ...
         const body = "submitdata=1$S210820017}2$上海御渡半导体科技有限公司}3$新增行程信息}5$(跳过)}6$(跳过)}7$已返肥-结果未出}8$已接种0针}9$其他^不认为疫苗有效}22$无以上疫情高中风险区域及特殊列管区域}27$-3}28$-3}29$-3}49$是}50$hj9r";
        const request = {
            url: url,
            headers: headers,
            body: body
