/*
cron "0 4-7,20 * * *" Youth_Read_wz2.js
*/
const $ = new Env("中青看点文章2")
//const notify = $.isNode() ? require('./sendNotify') : '';
let ReadArr = [], timebodyVal ="";
let YouthBody = $.getdata('youth_autoread_wz2')||$.getdata("zqgetbody_body");
...
function removebody() {
  ...
  if (articlebody !== ReadArr[0]) {
      smallbody = $.getdata('youth_autoread_wz2').replace("&" + articlebody, "");
  } else {
      smallbody = $.getdata('youth_autoread_wz2').replace(articlebody + "&", "")
  }
  $.setdata(smallbody, 'youth_autoread_wz2')
}
