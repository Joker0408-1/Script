/*
cron "0 8-11,21 * * *" Youth_Read_wz3.js
*/
const $ = new Env("中青看点文章3")
//const notify = $.isNode() ? require('./sendNotify') : '';
let ReadArr = [], timebodyVal ="";
let YouthBody = $.getdata('youth_autoread_wz3')||$.getdata("zqgetbody_body");
...
function removebody() {
  ...
  if (articlebody !== ReadArr[0]) {
      smallbody = $.getdata('youth_autoread_wz3').replace("&" + articlebody, "");
  } else {
      smallbody = $.getdata('youth_autoread_wz3').replace(articlebody + "&", "")
  }
  $.setdata(smallbody, 'youth_autoread_wz3')
}
