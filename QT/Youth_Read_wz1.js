/*
cron "0 0-3 * * *" Youth_Read_wz1.js
*/
const $ = new Env("中青看点文章1")
//const notify = $.isNode() ? require('./sendNotify') : '';
let ReadArr = [], timebodyVal ="";
let YouthBody = $.getdata('youth_autoread_wz1')||$.getdata("zqgetbody_body");
...
function removebody() {
  ...
  if (articlebody !== ReadArr[0]) {
      smallbody = $.getdata('youth_autoread_wz1').replace("&" + articlebody, "");
  } else {
      smallbody = $.getdata('youth_autoread_wz1').replace(articlebody + "&", "")
  }
  $.setdata(smallbody, 'youth_autoread_wz1')
}
