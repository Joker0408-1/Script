/*
cron "0 12-15,22 * * *" Youth_Read_wz4.js
*/
const $ = new Env("中青看点文章4")
//const notify = $.isNode() ? require('./sendNotify') : '';
let ReadArr = [], timebodyVal ="";
let YouthBody = $.getdata('youth_autoread_wz4')||$.getdata("zqgetbody_body");
...
function removebody() {
  ...
  if (articlebody !== ReadArr[0]) {
      smallbody = $.getdata('youth_autoread_wz4').replace("&" + articlebody, "");
  } else {
      smallbody = $.getdata('youth_autoread_wz4').replace(articlebody + "&", "")
  }
  $.setdata(smallbody, 'youth_autoread_wz4')
}
